...
// Leaflet no soporta SSR — carga diferida obligatoria en Next.js App Router
  ...
  return (
    <div className="rounded-xl border bg-card overflow-hidden">
      <div className="flex items-center justify-between px-4 py-3 border-b">
        ...
        {loading && (
          <span className="text-xs text-muted-foreground animate-pulse">Cargando puntos…</span>
        )}
      </div>
