...
import type { AdminCuarentenaActivationContextItem } from "@/modules/admin/cuarentenas/domain/entities/AdminCuarentenaDetailEntity";
import type { AdminCuarentenaType } from "@/modules/admin/cuarentenas/domain/entities/AdminCuarentenaEntity";
