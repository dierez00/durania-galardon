...
} from "@/modules/admin/cuarentenas/domain/repositories/adminCuarentenasRepository";
...
} from "@/modules/admin/cuarentenas/domain/entities/AdminCuarentenaDetailEntity";
