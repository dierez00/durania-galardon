...
type EditableField = "fullName" | "email" | "curp";

interface Props {
  detail: AdminProductorDetallado;
    ...
    >
      ...
      <div className="min-w-0 flex-1">
        ...
        {isEditing ? (
          ...
          {maxLength !== undefined && (
            <p className={cn(
              "text-[10px] text-right tabular-nums transition-colors",
...
export function AdminProductorInfoTab({
  detail,
  editingField,
  isSavingField,
  fieldError,
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
      ...
      <InfoRow
        ...
        label="CURP"
        value={detail.curp}
        rawValue={detail.curp ?? ""}
        field="curp"
        placeholder="AAAA000000HAAAAAA0"
        mono
        maxLength={18}
        uppercase
      />
      ...
      <InfoRow
        ...
        value={`${detail.totalBovinos} animales activos`}
        editingField={editingField}
        isSavingField={isSavingField}
      />
      <InfoRow
