...
export class UploadUppDocument {
  ...
  execute(file: File, uppId: string, documentType: string, expiryDate?: string): Promise<UppDocument> {
    return this.repository.upload(file, uppId, documentType, expiryDate);
  }
}
